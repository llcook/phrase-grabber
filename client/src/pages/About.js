...
function About() {
    return (
        <>
            ...
            <p>Each <Link to={"/api/notes"}>object</Link> represents one stored instance of speech recognition. Waves of text represent transcriptions stored while in progress.</p>
